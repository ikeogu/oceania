...
<script>
    ...
    function generate_cstorevoidPdf(receipt_id){
        ...
        $.ajax({
            url: "<?php echo e(route('cstore.generatevoidpdf')); ?>",
            headers: {
    ...
    function generate_cstorerefundPdf(receipt_id){
        ...
        $.ajax({
            url: "<?php echo e(route('cstore.generaterefundpdf')); ?>",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: 'post',
    ...
    var table = $('#cstoreReceiptlist').DataTable({
            ...
            "ajax": {
                ...
                "url": "<?php echo e(route('local_cabinet.cstore-list-table',[$date])); ?>",
                "type": "POST",
                data: function (d) {
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emmanuel/oceania/trunk/oceania/resources/views/cstore/cstore_receiptlist.blade.php ENDPATH**/ ?>