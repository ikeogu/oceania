...
<script type="text/javascript">
    ...
    function pdfPrintPDF(){
        ...
        $.ajax({
			url: "<?php echo e(route('c-storePL')); ?>",
            type: "POST",
            'headers': {
    ...
    function downloadExcelSL(){
        ...
        $.ajax({
			url: "<?php echo e(route('export_stock_ledger_excel')); ?>",
            type: "POST",
            'headers': {
			  'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
			},
    ...
    function downloadCVPDF(){
        ...
        $.ajax({
			url: "<?php echo e(route('cost_value_report')); ?>",
            type: "POST",
            'headers': {
			  'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
			},
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emmanuel/oceania/trunk/oceania/resources/views/report/report.blade.php ENDPATH**/ ?>