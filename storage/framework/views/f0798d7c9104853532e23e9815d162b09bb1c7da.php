...
<div class="rec_id" style="font-size: 14px; font-weight: bold;" id="<?php echo e($receipt->id); ?>">
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="table" id="item" style="width:100%;padding:0px !important;margin:0px !important;">
    ...
    <tr id="table-th" style="border-style: none;font-size:12px;">
        ...
        <th valign="middle" class="text-right" width="15%"><?php echo e(!empty($receipt->currency) ? $receipt->currency : 'MYR'); ?></th>
    </tr>
    ...
    <?php $__currentLoopData = $receiptproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="table-td" style="margin-bottom:10px !important;">
                    <td style="text-align:left;border-style: none">
                        <span><?php echo e(!empty($product->name)?$product->name:"RON95"); ?></span>
                    </td>
                    <td style="text-align:center;border-style: none">
                        <span> <?php echo e(!empty($product->quantity)?number_format($product->quantity):"1"); ?></span>
                    </td>
  ...
  <hr style="border:0px !important;padding:3px !important;margin:0px !important;">
   <hr class="solid" style="margin: 0px !important;padding: 0px !important;"><hr style="border:0px !important;padding:3px !important;margin:0px !important;">
    ...
    <tr>
        <td style="text-align: left;font-weight: normal">
            <span style="font-weight: normal"><?php echo e(!empty($terminal->taxtype)?strtoupper($terminal->taxtype):"SST"); ?> <?php echo e((float) $receipt->service_tax??"6"); ?>%</span>
        </td>
        <td style="text-align: right;font-weight: normal;">
   ...
   <hr class="solid" style="margin: 0px !important;padding: 0px !important;"><hr style="border:0px !important;padding:3px !important;margin:0px !important;">
    ...
    <tr>
        ...
        <td style="text-align: right;font-weight: normal">
            <span
                style="font-weight: normal"><?php echo e(!empty($receipt->systemid)?$receipt->systemid:""); ?></span>
        </td>
    </td>
    <tr>
        <td style="text-align: left;font-weight: normal">
...
<?php /**PATH /home/emmanuel/oceania/trunk/oceania/resources/views/cstore/cstore_autopdf.blade.php ENDPATH**/ ?>