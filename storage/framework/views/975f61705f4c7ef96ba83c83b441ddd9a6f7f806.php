		...
		<div class="d-flex mt-0 p-0"
			...
			<div class="col-md-2 text-right pr-0"
				...
				<button class="btn btn-success sellerbutton-wide btn-sq-lg
					screend-button-lg"
					onclick="window.open('<?php echo e(route('cstore_returning')); ?>','_blank')"
...
<script>
    ...
    // Table definition
      ...
      let auditedReportList =  $('#returningList').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: "<?php echo e(route('returning.display_returning_list')); ?>",
                type: 'GET',
                cache: false,
                data: function (d) {
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emmanuel/oceania/trunk/oceania/resources/views/returning/cstore_returning_list.blade.php ENDPATH**/ ?>