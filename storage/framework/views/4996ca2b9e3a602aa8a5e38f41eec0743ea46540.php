        ...
        <?php $__currentLoopData = $product_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr class="table-td">
                ...
                <td style="text-align:center;border-style: none">
                    ...
                    <?php
                        $qty = $product->status !='voided' ? $product->quantity : 0;
                        $amount =$product->status !='voided' ? $product->item_amount : 0;
                        $grandTotal+=$amount;
                    ?>
				...
				<td style="text-align:right;border-style: none">
					<?php echo e(number_format(($amount/100),2)); ?>
...
<?php /**PATH /home/emmanuel/oceania/trunk/oceania/resources/views/sales_report/sales_report_pdf.blade.php ENDPATH**/ ?>