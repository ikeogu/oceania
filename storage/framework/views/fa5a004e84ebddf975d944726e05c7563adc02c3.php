...
<script>
				...
				if ((typeof resp.response != 'undefined') &&
					...
					if ((typeof response.Packets != 'undefined') &&
						...
						if ((packet.Type == 'PumpIdleStatus') &&
							...
							var tid = <?php echo e($terminal->id); ?>;
	...
	async function fetch_latest_receipt_id(my_pump) {
		let res;
        await $.ajax({
            url: "<?php echo e(route('fuel.fetch-latest-receipt-id')); ?>",
            headers: {
	...
	*/
    ...
    function fuel_generate_pdf(receipt_id){
        ...
        $.ajax({
            url: "<?php echo e(route('receipt.generatepdf')); ?>",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: 'post',
    ...
    function generate_voidPdf(pump_no){
        ...
        $.ajax({
            url: "<?php echo e(route('receipt.generatevoidpdf')); ?>",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: 'post',
...
<!-- FUEL PAGE CODE ENDS -->
<?php /**PATH /home/emmanuel/oceania/trunk/oceania/resources/views/landing/opos_fuelpage.blade.php ENDPATH**/ ?>