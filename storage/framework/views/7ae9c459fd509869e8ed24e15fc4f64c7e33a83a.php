...
function show_doc_qty_modal(stock_out, op_id) {
    ...
    $.ajax({
        method: "post",
        url: "<?php echo e(route('locprod.qty-distribution.datatable')); ?>",
        data: {
        	op_id: op_id
        }
    })
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emmanuel/oceania/trunk/oceania/resources/views/local_price/prodloc_cost.blade.php ENDPATH**/ ?>