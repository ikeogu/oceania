...
<div class="modal-body" style="font-size: 14px; font-weight: bold;">
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            ...
            <!-- {{json_encode($eoddetailsdata)}}     -->
            {{number_format(((( ($eoddetailsdata->sales ?? 0) -
				$reverseAmount)??"0.00")/100),2)}}
			<!--
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
			...
			{{number_format((((($eoddetailsdata->sst ?? 0) -
				$reverseTax)??"0.00")/100),2)}}
            </strong>
        </div>
    </div>
	--}}
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong style="font-weight:normal" id="item_amount">
                {{number_format(((($eodSales)??"0.00")/100),2)}}
            </strong>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                {{number_format((((($eodTax ?? 0 )- $reverseTax)??"0.00")/100),2)}}
            </strong>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                {{number_format(((($eodCash)??"0.00")/100),2)}}
            </strong>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                {{number_format(((($eodCreditCard)??"0.00")/100),2)}}
            </strong>
        </div>
    </div>
	...
	<div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                {{number_format(((($eodWallet)??"0.00")/100),2)}}
            </strong>
        </div>
    </div>
	...
	<div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="credit_account" style="font-weight: normal;">
                {{number_format(((($eodcreditAccount)??"0.00")/100),2)}}
            </strong>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="text-align: right;">
            <strong id="item_amount"
				...
				{{empty($opos_eoddetails->creditcard) ? '0.00' :
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="text-align: right;">
            <strong id="item_amount"
				style="font-weight: normal;">
				{{number_format(((($eodOew)??"0.00")/100),2)}}
			</strong>
        </div>
    </div>
    ...
    <!--section 3 ends-->
	   ...
	   @if($refund_data != 0)
		...
		<div class="row">
			...
			<div class="col-md-6 text-right" style="font-weight: normal;color:orange">
				{{number_format(( $refund_data ??"0.00")/100,2)}}
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6 text-right" style="font-weight: normal;color:orange">
				{{number_format(( $refund_sst ??"0.00") / 100,2)}}
			</div>
		</div>
	 ...
	 <!--section 3 starts-->
		<div class="row">
			...
			<div class="col-md-6 text-right" style="font-weight: normal;color:orange">
				{{number_format(( $refund_round ??"0.00") / 100,2)}}
			</div>
		</div>
