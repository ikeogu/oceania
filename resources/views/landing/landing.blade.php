			...
			<div hidden class="prd-overlay" id = "prd-overlay-{{$s}}">
				<div class="row prd-top-row"
					...
					<div class="col-sm-5 m-0 p-0 text-right">
						<span id="prd-myr-{{$s}}" style="margin-right:5px"></span>
						...
						<div class="row m-0 p-0 w-100">
							<div class="col-sm-12 m-0 p-0">
								...
								<input class="cover-input-new" type="number"
									...
									placeholder='0.00' id="myr_amount_input_{{$s}}"/>

								<input class="hide" type="number"
									id="myr_amount_input_{{$s}}_buffer"/>
					...
					<div class="col-sm-5 m-0 p-0" style="display: flex;height: 35px;">
						...
						<div class="row m-0 p-0 w-100">
							<div class="col-sm-12 m-0 p-0">
								<input class="cover-input-new" type="number"
									style="height: 100%;width:105px;color:white;"
									placeholder='0.00' id="litre_amount_input_{{$s}}"/>

								<input class="hide" type="number"
									id="litre_amount_input_{{$s}}_buffer"/>
								...
								<button class="cover-input-btn"
									...
									position:relative;top:-1px;
									font-size:16px; width:60px !important"
									onclick="process_custom_litre({{$s}})">
									Litre
								</button>
							</div>
						</div>
				...
				<div style=""
					...
					<br/>
                        <div style="font-size:20px;color:yellow;width: 100%;text-align: center;"
                            ...
                            @else
								<form method="post" action="{{ route('uPLogin') }}" autocomplete="off">
									@csrf
					...
					<div style="padding-right:0;min-height: 200px;"
						...
						<div class="flex_table" >
							<div class="col-md-12 mt-auto w-100 mr-0 pr-1 pl-0"
								...
								<div class="d-flex bd-highlight">
									<div class="mr-auto bd-highlight text-white">
										SST {{!empty($terminal->tax_percent)?$terminal->tax_percent:""}} %
...
@if (!empty($isLocationActive) && (!empty($isTerminalActive)))
	...
	@include('landing.myr_logic')
	@include('landing.litre_logic')
