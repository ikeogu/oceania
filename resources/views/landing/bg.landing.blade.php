			...
			<div class="row" style="margin-bottom:5px !important">
				<div style="padding-right:20px;" class="col-md-12 pl-0 mt-1"
					...
					<div class="col-md-12" style="position:absolute;
						width:370px; left:0;bottom:0;padding:0px;">
			...
			<div class="row" style="">
				<div class="col-md-12 pr-0 pl-0">
					<button class="btn btn-success btn-sq-lg screend-button
						...
						font-size: 14px; width: 145px !important;">
					<span style="">Today<br>Cabinet</span>
					</button>
					<button onclick="pumpCancel(2)" class="btn btn-sq-lg
						numpad-cancel-payment2
						poa-button-number-payment-cancel-disabled" style="display: none">Cancel
					</button>
