			...
			<div style="min-height:100px;max-height:100px;display:flex"
				...
				<div class="row text-white"
					...
					<img src='' id="fuel-grad-thumb-{{$i}}"
						style='width:45px;height:45px;display:inline-block;cursor:pointer;object-fit: contain;
						background-color:white; border-radius:5px; margin-right: 2px;display:none'>
					...
					@foreach ($productData as $product)
						@if (!empty($nozzleFuelData->
							...
							<img src='/images/product/{{$product->systemid}}/thumb/{{$product->thumbnail_1}}'
								...
								style='width:45px;height:45px;display:inline-block;cursor:pointer;object-fit: contain;
								background-color:white; border-radius:5px; margin-right: 2px;' />
						@endif
					@endforeach
					@endif
				</div>
