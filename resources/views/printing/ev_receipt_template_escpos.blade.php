...
//	'123456789012345678901234567890123456789012345'
	'EV Charger              {{$receipt->hours}}  {{ number_format($receipt->rate / 100, 2) }}  {{number_format($receiptdetails->discount / 100, 2)}}  {{ number_format(number_format($receipt->rate / 100, 2)*$receipt->hours,2) }}' + '\x0A',
	'---------------------------------------------' + '\x0A',
...
//	'123456789012345678901234567890123456789012345'
	...
	'\x1B' + '\x21' + '\x08',	// emphasized mode on
	'Total                    '+'{{str_pad(
	number_format($receiptdetails->item_amount / 100 + $receiptdetails->sst / 100 + $receiptdetails->rounding / 100, 2), 20, " ", STR_PAD_LEFT)}}' + '\x0A',
	'\x1B' + '\x21' + '\x00',	// emphasized mode off
...
//	'123456789012345678901234567890123456789012345'
	...
	'Lot No.                  '+'{{str_pad($receiptdetails->lot_no??'', 20, " ", STR_PAD_LEFT)}}' +'\x0A',
