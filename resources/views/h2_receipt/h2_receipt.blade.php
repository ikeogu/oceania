     ...
     background-color:white;border:0;pointer-events:none">
      ...
      margin-right:15px" />
			...
			<button class="btn opos-h2-button"
				id="h2_btn"
				style="float:left !important;pointer-events:none;
				position:relative;left:-10px">
				<img src="{{asset('images/h2_logo_black.png')}}"
					style="margin-left:0;margin-right:0;
					margin-top:0;width:70px;
					filter:invert(100%);
            ...
            success: function(response) {
                ...
                if (!error1) {
                    try {
                        ...
                        error2 = true;
                        console.error('ERROR escpos_print_template(): ' + JSON.stringify(exc));
                    }
                }
            },
            error: function(e) {
