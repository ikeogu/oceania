...
<script type="text/javascript" src="{{asset('js/opossum_qz.js')}}"></script>
    <style>
        ...
        #receipt-table_length, #receipt-table_filter, #receipt-table_info, .paginate_button {
            color: white !important;
        }

        #eodSummaryListModal-table_paginate, #eodSummaryListModal-table_previous, #eodSummaryListModal-table_next, #eodSummaryListModal-table_length, #eodSummaryListModal-table_filter, #eodSummaryListModal-table_info {
            color: white !important;
        }
    ...
    <div id="landing-view">
        ...
        <div class="container-fluid">
            ...
            <form action="{{route('sales.report.print.pdf')}}" method="POST">
                ...
                <div style="right:200px;display:inline;padding-left:40px;margin-bottom:20px">
