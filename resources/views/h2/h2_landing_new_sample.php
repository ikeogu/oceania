			...
			<div class="row" style="margin-bottom:5px !important">
				<div style="padding-right:20px;min-height: 280px;"
					...
					<div class="row p-0 m-0 text-white">
						<div class="col-4 p-0 m-0" id="table-PRODUCT-2"></div>
						
						<div class="col-3 text-center" id="table-PRICE-2"></div>

						<div class="col-3 text-center" id="table-QTY-2"></div>
					...
					<div class="col-md-12 mt-auto pt-2 pb-0 m-0 pl-0 pr-0"
						...
						<div style="justify-content:flex-end;display:flex"
							...
							<button class="btn btn-sq-lg
								button-number-amount poa-button-number"
...
<div class="col-md-7"
	style="position:relative;left:0;margin-top:-10px; padding:0px">
				...
				margin-left: 0px;">
					...
					<div class="col-md-12 p-0 m-0">
						...
						{{-- <div class="row text-white"
							id="product-display-pump-{{$s}}"
							style="position:relative;top:0;left:0;
							align-items:center;">
							<img src='' id="fuel-grad-thumb-{{$s}}"
     ...
     style="display: inline-flex;">
        ...
        style="width: 100%;  background-color: {{@$color}} !important" >
            ...
            <div class="modal-body text-center pt-0 pb-0">
                <h5 class="modal-title text-white" id="statusModalLabelMsg">
				</h5>
            </div>
