...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table" id="item" style="margin-top: 5px; width:100%">
        ...
        <tr id="table-th" style="border-style: none">
            ...
            <th valign="middle" class="text-left" style="">Receipt ID</th>
            <th valign="middle" class="text-center" style="width:10%;">Total</th>
            <th valign="middle" class="text-center" style="width:10%;">Fuel</th>
            <th valign="middle" class="text-center" style="width:10%;">Filled</th>
            <th valign="middle" class="text-center" style="width:15%;">Refund</th>
        </tr>
        </thead>
        ...
        @foreach($product_details as $key => $product)
            <?php
            $grandTotal+=$product->rec_price/(($product->tax+100)/100);
            ?>
            <tr class="table-td">
