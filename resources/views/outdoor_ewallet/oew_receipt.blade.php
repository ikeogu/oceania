...
<div class="rec_id modal-body" style="font-size: 14px; font-weight: bold;" id="{{ $receipt->id }}">
    ...
    <div class="row" style="text-align:center;">
        <div class="col-md-12 text-center mt-4">
            @if (!empty($receipt->id) && !empty($receipt->receipt_logo))
 ...
 ">
   ...
   @if ($receipt->status == 'voided') block;
    ...
    float: left;margin-bottom: 5px; border-radius: 10px;">
        ...
        <div class="col-md-12 d-flex" style="margin: 0 5px;">
    ...
    font-size:13px;border-radius:10px; " onclick="print_receipt({{ $receipt->id }})">
            ...
            @if ($refund && $receipt->status === 'refunded')
                <button id="oew_btn" class="btn"
            style="padding-left:0;padding-right:0; margin-right:0;background-color: #3a3535;
            width:70px;height:70px;position:relative;left: 10px; color: white; cursor:not-allowed;
            font-size:13px;border-radius:10px;"
                disabled="disabled">
                    <strong>Refund</strong>
                </button>
            @else
                <button id="oew_refund_btn" class="btn btn-warning"
                style="padding-left:0;padding-right:0; margin-right:0;background-color: rgb(255,126,48);
                width:70px;height:70px;position:relative;left: 10px; color: white;
                font-size:13px;border-radius:10px;"
                onclick="refundMe({{$receipt->id}}, {{$receiptdetails->total / 100}}, {{$receiptdetails->filled / 100}})">
                    <strong>Refund</strong>
                </button>
            @endif
    ...
    <div class="container">
        <div style="font-size:14px;text-align:left; color:orange">
            ...
            <div class="row">
                ...
                <div class="col-md-8 pl-0 text-right">
                    <span
                        style="font-weight: normal">{{ number_format($refund->newsales_item_amount / 100, 2) }}</span>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 pr-0">
                    <span style="font-weight: normal">{{ 'SST ' . (float) $receipt->service_tax ?? '6' }}%</span>
                </div>
                <div class="col-md-8 pl-0 text-right">
                    <span
                        style="font-weight: normal">{{ number_format($refund->newsales_tax / 100, 2) }}</span>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 pr-0">
                ...
                <div class="col-md-8 pl-0 text-right">
                    <span
                        style="font-weight: normal">{{ number_format($refund->newsales_rounding / 100, 2) }}</span>
                </div>
            </div>
            <hr style="width:100%;border: 0.5px solid #c0c0c0;margin-top:5px !important">
