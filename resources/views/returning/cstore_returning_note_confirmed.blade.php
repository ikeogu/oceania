         ...
         <div style="margin-top: 0;margin-right:5px; margin-left:5px;">
            ...
            style="margin-top: 0px; width:100%">
                ...
                <tbody id="shows">
                    ...
                    <tr>
                        <td> {{ $key + 1 }}</td>
                        <td class="text-center">{{ $report->barcode }}</td>
                        ...
                        <td class="text-right"> {{ number_format($report->cost /100,2) }}</td>
...
function downLoadExcel(){
    ...
    $.ajax({
		url: "{{route('returning.excel_download')}}",
