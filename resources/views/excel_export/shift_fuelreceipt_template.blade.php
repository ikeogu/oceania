...
<td>
    ...
    <table>
        ...
        <tbody>
			...
			@endphp
			<tr>
				<td style='text-align:center;'>{{$nshift_count}}</td>
				<td>{{$i->in}}</td>
				<td>{{$i->out}}</td>
				<td>{{$i->staff_systemid}}</td>
				<td>{{$i->staff_name}}</td>
				<td data-format="0.00">=v{{ $tbl }}</td>
				...
				<td data-format="0.00" style='text-align:right;'>{{trim("=T$cnt-H$cnt-I$cnt")}}</td>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td  style='text-align:right;' data-format="0.00">{{$i->status=='voided'? 0: $i->total/100}}</td>
                <td  style='text-align:right;' data-format="0.00">{{ $i->status =='refunded' ? $i->newsales_rounding/100:$i->rounding/100 }}</td>
                ...
                <td  style='text-align:right;' data-format="0.00">{{  $i->status=='voided'?  $i->total/100:' ' }}</td>
