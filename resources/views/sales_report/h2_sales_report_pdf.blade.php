...
<body>
	<table border="0" style="width:100%; border-collapse: collapse"
		...
		<tr>
			<td valign="bottom" colspan="5" align="right" >
				...
				@if(!empty($requestValue['h2_start_date']) &&
					!empty($requestValue['h2_end_date']))
						{{ date('dMy',strtotime($requestValue['h2_start_date'])) }} -
						{{ date('dMy',strtotime($requestValue['h2_end_date'])) }}
				@endif
				</p>
		  </td>
		</tr>
	...
	Refund
	<span style="font-size:18px;float:right;position:relative;top:8px;">Hydrogen<span>
	</h2>
