...
<body>
	<table border="0" style="width:100%; border-collapse: collapse"
		...
		<tr>
			<td valign="bottom" colspan="5" align="right" >
				...
				@if(!empty($requestValue['oew_start_date']) &&
					!empty($requestValue['oew_end_date']))
						{{ date('dMy',strtotime($requestValue['oew_start_date'])) }} -
						{{ date('dMy',strtotime($requestValue['oew_end_date'])) }}
				@endif
				</p>
		  </td>
		</tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0"
        ...
        <tr id="table-th" style="border-style: none">
            ...
            <th valign="middle" class="text-center" style="width:10%;">Net Qty</th>
        ...
        @foreach($product_details as $key => $product)
            <?php
				$grandTotal+=($product->item_amount / 100);
			?>
            <tr class="table-td">
	...
	Refund
	<span style="font-size:18px;float:right;position:relative;top:8px;">Outdoor e-Wallet<span>
	</h2>
    <table border="0" cellpadding="0" cellspacing="0" class="table"
        ...
        @foreach($refund as $key => $product)
            ...
            <tr class="table-td">
                ...
                <td style="text-align:right;border-style: none">
                    {{number_format($product->refund_amount/100,2) }}
                </td>
            </tr>
        @endforeach
