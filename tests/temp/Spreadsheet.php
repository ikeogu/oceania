...
class Spreadsheet
{
    ...
    {
        Log::info('PF EX export: createSheet func');
    ...
    {
        Log::info('PF EX export: addingSheet');
        ...
        if ($sheetIndex === null) {
            Log::info('PF EX export: sheetIndex'.$sheetIndex);
        ...
        Log::info('PF EX export: AddSheet->return worksheet' . json_encode($worksheet));
        return $worksheet;
    }
