...
class Html extends BaseReader
{
    ...
    {
        // Validate
        Log::info("***** loadIntoExisting: START *****");
        ...
        try {
            ...
            Log::info("loadIntoExisting: convert:securityScanner:scanFile: ");
            ...
            Log::info("loadIntoExisting: convert:securityScanner:scanFile: BEFORE: preg_replace_callback");
            $convert = preg_replace_callback($regexp, $callback, $convert);

            Log::info("loadIntoExisting: convert:securityScanner:scanFile: AFTER: preg_replace_callback");

            $loaded = ($convert === null) ? false : $dom->loadHTML($convert);

            Log::info("loadIntoExisting: convert:loadHTML: ");
        } catch (Throwable $e) {
            $loaded = false;
        }
        if ($loaded === false) {
