...
class CreateOewReceiptproductTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('oew_receiptproduct', function (Blueprint $table) {
            $table->id();
            // FK to fuel_receipt.id
            $table->integer('receipt_id')->unsigned();
            // FK to product.id
            $table->integer('product_id')->unsigned();
            $table->string('product_systemid')->nullable();
    ...
    {
        Schema::dropIfExists('oew_receiptproduct');
    }
}
