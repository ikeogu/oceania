...
class CreateFuelFulltankReceiptdetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fuelfulltank_receiptdetails', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fuelfulltank_receiptdetails');
    }
}
