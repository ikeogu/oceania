...
class CreateOptReceiptTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('opt_receipt', function (Blueprint $table) {
			...
			* This is stored as percent e.g. 6.5% */
			...
			$table->enum('payment_type',
			  ['cash','creditcard','point','wallet','creditac','opt'])->
			  default('opt');
			...
			* receipt logo */
			...
			// Transacted type
			$table->enum('transacted',['opt','pos','wallet','oew'])->default('opt');
    ...
    {
        Schema::dropIfExists('opt_receipt');
    }
}
