...
class CreateFuelFulltankReceiptTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fuelfulltank_receipt', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fuelfulltank_receipt');
    }
}
