...
Route::post("/carparkoper/changeMode", "CarparkController@changeMode")->
name("carparkoper.changeMode");
...
Route::post("/carparkoper/multiTransactionCheck", "CarparkController@multiTransactionCheck")->
name("carparkoper.multiTransactionCheck");
